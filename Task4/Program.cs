namespace Task4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Student { Name="Akriti" },
                new Student { Name="Rajan" },
                new Student { Name="Rahul" },
                new Student { Name="Anshu" },
                new Student { Name="Shreya" },
                new Student { Name="Laxmi" },
                new Student { Name="Dinesh" },
                new Student { Name="Ajay" },
                new Student { Name="Sandesh" },
                new Student { Name="Kalpana" }
            };
